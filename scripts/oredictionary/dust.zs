...
<ore:crushedPurifiedAluminum>.remove(<galacticraftcore:ic2compat:1>);
<ore:crushedAluminum>.remove(<galacticraftcore:ic2compat:2>);

<ore:dustZinc>.remove(<ncsteamadditions:dust>);
